...
import 'ds_form_validators.dart';
...
class DsValidatorSets {
  ...
  static String? Function(String?) get patientName =>
      (value) => DsFormValidators.validatePersonName(value, context: 'patient');
  ...
  static String? Function(String?) get patientEmail =>
      (value) => DsFormValidators.validateEmail(value, context: 'patient');
  ...
  static String? Function(String?) get patientBirthDate =>
      DsFormValidators.validateBirthDate;
  ...
  static String? Function(String?) get patientProfession =>
      (value) => DsFormValidators.validateProfession(value, maxLength: 100);
  ...
  static String? Function(String?) get screenerName =>
      (value) => DsFormValidators.validatePersonName(value, context: 'screener');
  ...
  static String? Function(String?) get screenerEmail =>
      (value) => DsFormValidators.validateEmail(value, context: 'screener');
  ...
  static String? Function(String?) get medicationList =>
      DsFormValidators.validateMedicationList;
  ...
  static String? Function(String?) customTextField({
    ...
    return (String? value) {
      return DsFormValidators.validateTextField(
        value,
        fieldName: fieldName,
        required: required,
        minLength: minLength,
