...
class _ThankYouPageState extends State<ThankYouPage> {
  ...
  Future<AgentResponse?> _startAndPollAgentResponse(
    ...
    final taskStart = await repository.startClinicalWriterTask(
      ...
      flowKey: RuntimeAccessPointCatalog
      ...
      body: Column(
        ...
        children: [
          ...
          DsHandoffFork(
            ...
            subtitle:
                'Você pode ajustar dados da avaliação ou seguir direto para o relatório clínico detalhado.',
            actions: [
              DsHandoffForkAction(
                title: 'Revisar informações da avaliação',
                description:
                    'Volte para ajustar os dados coletados antes de concluir o relatório.',
                primaryLabel: 'Adicionar informações',
                onPrimaryPressed: _restartSurveyFlow,
