...
- Implementação de mecanismos de controle que permitam ao usuário voltar em etapas anteriores sem perda de dados (quando o domínio permitir).
...
### New Capabilities
- `multi-step-progress-standard`: Define como o progresso deve ser visualizado em fluxos com mais de duas etapas, incluindo nomes de fases e estados de conclusão.
- `user-navigation-orientation`: Define padrões de feedback visual e textual para manter o usuário orientado sobre sua posição na hierarquia do app e no fluxo atual.
