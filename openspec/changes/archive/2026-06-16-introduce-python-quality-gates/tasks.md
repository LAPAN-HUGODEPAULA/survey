...
- [x] **5. Implement Unified Quality Gate Runner**
...
- [x] **6. Document Commands in Project Guidelines**
...
- [x] **V1.** Git commit fails on seeded syntax, lint, type, or Skylos violation.
- [x] **V2.** Git commit succeeds when files have no new quality regressions.
