...
O sistema DEVE exibir uma área de status unificada acima da área de entrada, informando a fase atual da IA (ex: "Analisando sinais clínicos") e oferecendo controles de cancelamento ou retentativa.

#### Scenario: Interromper análise de IA
- **WHEN** uma análise está em andamento e o usuário clica em "Cancelar"
- **THEN** o sistema interrompe o processamento e retorna a área de entrada para o estado pronto
