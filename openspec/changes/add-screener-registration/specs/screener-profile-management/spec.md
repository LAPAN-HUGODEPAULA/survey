...
### Requirement: Update Settings Page
The `settings_page.dart` in `survey-frontend` MUST be updated to remove screener information.
...
### Requirement: Update Top Menu
The top menu in `survey-frontend` MUST be updated to include a profile icon with login and settings options.
