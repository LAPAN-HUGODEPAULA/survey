# clinical-prompt-catalog-governance Specification

## Purpose
Define the governance rules and taxonomy for the Clinical Writer prompt catalog, ensuring clinical logic is decomposed from persona style and that authorship remains traceable and safe.
