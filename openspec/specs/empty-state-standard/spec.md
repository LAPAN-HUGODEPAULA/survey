# empty-state-standard Specification

## Purpose
The purpose of this specification is to standardize the "Empty State" experience across the LAPAN Survey Platform, ensuring users are not left without direction when no data is available.
